...
void ObjectContain::Start ()
{
	...
	if (obsMod == "multi")
	{
		...
		else if (unitN == 24)
		{
			...
			ang[0] = 0.0/360.0*2*PI;
			ang[1] = 90.0/360.0*2*PI;
			ang[2] = 120.0/360.0*2*PI;
			ang[3] = 20.0/360.0*2*PI;
			ang[4] = 800.0/360.0*2*PI;
			ang[5] = 100.0/360.0*2*PI;
			ang[6] = 110.0/360.0*2*PI;
			ang[7] = 170.0/360.0*2*PI;
			ang[8] = 200.0/360.0*2*PI;
			ang[9] = 30.0/360.0*2*PI;;
			ang[10] = 195.0/360.0*2*PI;
			ang[11] = 295.0/360.0*2*PI;	
			ang[12] = 130.0/360.0*2*PI;
			ang[13] = 180.0/360.0*2*PI;
			ang[14] = 225.0/360.0*2*PI;
			ang[15] = 40.0/360.0*2*PI;
			ang[16] = 270.0/360.0*2*PI;
			ang[17] = 330.0/360.0*2*PI;
			ang[18] = 10.0/360.0*2*PI;
			ang[19] = 240.0/360.0*2*PI;
			ang[20] = 310.0/360.0*2*PI;

			ang[21] = 20.0/360.0*2*PI;	
			ang[22] = 250.0/360.0*2*PI;
			ang[23] = 340.0/360.0*2*PI;
			ang[24] = 120.0/360.0*2*PI;
			ang[25] = 180.0/360.0*2*PI;
			ang[26] = 245.0/360.0*2*PI;
			ang[27] = 250.0/360.0*2*PI;
			ang[28] = 270.0/360.0*2*PI;
			ang[29] = 320.0/360.0*2*PI;
			ang[30] = 200.0/360.0*2*PI;
			ang[31] = 260.0/360.0*2*PI;
			ang[32] = 340.0/360.0*2*PI;
		}
	}
	// Create Map
